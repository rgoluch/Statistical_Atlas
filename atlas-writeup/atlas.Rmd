...
At the time the Statistical Atlas for the ninth census was created, Mosaic plots were a novel way of visualizing data. Even though area plots as a means of visualizing data had been in use before [@friendly], e.g. Minard's [@minard] plate #3 [@newyork], Mosaic plots in their modern form of use were not published until 1877 [@mayr].
