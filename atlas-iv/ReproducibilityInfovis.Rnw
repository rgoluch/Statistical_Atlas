...
\item
 Heike Hofmann is with the Department of Statistics and member of the Human Computer Interaction Program, Iowa State University. E-mail: hofmann@mail.iastate.edu.
\item
...
<<overall-work-plot, out.width='.7\\columnwidth', fig.width=5, fig.height=5.5, echo = FALSE, message=FALSE, fig.pos="center", fig.cap="Recreation of the mosaicplot based on gainfully employed population over ten.\\label{fig:us-plate32-redo}">>=
