...
\autoref{fig:map} is similar to maps included in the 1880 and 1890 Statistical Atlases that show the geographic strength of the most common denominations.
