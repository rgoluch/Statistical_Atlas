...
\begin{figure}
  ...
  % \end{subfigure}
\caption{Old and new side-by-side: The replicated picture uses the Paired Colorbrewer2 scheme\cite{colorbrewer}. On the right we see that the number of unaccommodated people over the age of ten is higher than the number of sittings in any of the denominations.}
