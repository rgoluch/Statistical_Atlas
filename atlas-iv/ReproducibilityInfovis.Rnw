...
\caption{Old and new side-by-side: denominations are ordered  from top to bottomaccording to the nation-wide number of sittings. On the right, all denominations  are shown that were accommodated for in 1874. We also see that the number of unaccommodated people over the age of ten is higher than the number of sittings in any of the denominations.}
\end{figure}
