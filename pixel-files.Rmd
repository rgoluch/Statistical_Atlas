...
combo2 %>% 
  ggplot(aes(x = Agriculture.x/employed.x, y = Agriculture.y/employed.y)) +
  geom_point()
combo2 %>% 
  ggplot(aes(x = Manufacturing.x/employed.x, y = Manufacturing.y/employed.y)) +
  geom_point()
combo2 %>% 
  ggplot(aes(x = Trade.x/employed.x, y = Trade.y/employed.y)) +
  geom_point()
combo2 %>% 
  ggplot(aes(x = Services.x/employed.x, y = Services.y/employed.y)) +
  geom_point()
combo2 %>% 
  ggplot(aes(x = School.x/employed.x, y = School.y/employed.y)) +
  geom_point()
...
occ <- occupation %>% gather(key="Occupation", value="Number", 2:6, factor_key = TRUE)
